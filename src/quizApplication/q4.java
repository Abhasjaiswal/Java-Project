...
public class q4 extends JFrame {
    ...
    private static final long serialVersionUID = -3985057624056040628L;
    JPanel contentPane;
    ...
    public q4(String name, int m, int count) {
        ...
        setTitle("Quiz Application - Question 4");
        ...
        JLabel headerLabel = new JLabel("Question 4");
        ...
        // Question label
        JLabel lblNewLabel = new JLabel("Which of the following is NOT a valid way to create a Thread in Java?");
        ...
        // Options
        JRadioButton opt1 = new JRadioButton("Extending the Thread class");
        ...
        JRadioButton opt2 = new JRadioButton("Implementing the Runnable interface");
        ...
        JRadioButton opt3 = new JRadioButton("Implementing the Callable interface");
        ...
        JRadioButton opt4 = new JRadioButton("Extending the Threadable class");
        ...
        previousButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                question3.setLocationRelativeTo(null); // Center the window
        ...
        nextButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                else if(opt1.isSelected() == false && opt2.isSelected() == false && opt3.isSelected() == false) {
