...
public class q9 extends JFrame {
    ...
    // Custom colors for the UI (matching mainPage and q1)
    ...
    public q9(String name, int m, int count) {
        ...
        setTitle("Quiz Application - Question 9");
        ...
        JLabel headerLabel = new JLabel("Question 9");
        ...
        // Question label
        JLabel lblNewLabel = new JLabel("<html>What is the output of the following code?<br><br>" +
        ...
        // Options
        JRadioButton opt1 = new JRadioButton("Hello World");
        ...
        JRadioButton opt2 = new JRadioButton("Hello");
        ...
        JRadioButton opt3 = new JRadioButton("World");
        ...
        JRadioButton opt4 = new JRadioButton("Compilation Error");
        ...
        rightWrapper.add(nextButton, BorderLayout.EAST);
        ...
        nextButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if(opt2.isSelected()) {
                    ...
                    question10.setLocationRelativeTo(null); // Center the window
