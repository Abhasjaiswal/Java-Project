...
public class q3 extends JFrame {
    ...
    // Custom colors for the UI (matching Q1)
    ...
    public q3(String name, int m, int count) {
        ...
        setTitle("Quiz Application - Question 3");
        ...
        JLabel headerLabel = new JLabel("Question 3");
        ...
        // Question label
        JLabel lblNewLabel = new JLabel("What is the default value of float variable?");
