...
public class q2 extends JFrame {
    ...
    private static final Color SECONDARY_COLOR = new Color(135, 206, 235); 
    private static final Color BUTTON_COLOR = new Color(0, 102, 204); 
    private static final Color HOVER_COLOR = new Color(30, 144, 255); 
    ...
    public q2(String name, int m, int count) {
        ...
        setTitle("Quiz Application - Question 2");
        ...
        JLabel headerLabel = new JLabel("Question 2");
        ...
        JLabel lblNewLabel = new JLabel("What is the size of int variable?");
        ...
        // Add button to the right side of the button panel
