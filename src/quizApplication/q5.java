...
public class q5 extends JFrame {
    ...
    private static final long serialVersionUID = -7821436587945183257L;
    JPanel contentPane;
    ...
    public q5(String name, int m, int count) {
        ...
        setTitle("Quiz Application - Question 5");
        ...
        JLabel headerLabel = new JLabel("Question 5");
        ...
        // Question label
        JLabel lblNewLabel = new JLabel("Which of the following is not a Java features?");
        ...
        // Options
        JRadioButton opt1 = new JRadioButton("Dynamic");
        ...
        JRadioButton opt2 = new JRadioButton("Use of pointers");
        ...
        JRadioButton opt3 = new JRadioButton("Object-oriented");
        ...
        JRadioButton opt4 = new JRadioButton("Platform independent");
        ...
        prevButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Assuming q4 exists in your application
                q4 question4 = new q4(s1, m1, c);
                question4.setLocationRelativeTo(null); // Center the window
