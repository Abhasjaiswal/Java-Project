...
public class q8 extends JFrame {
    ...
    public q8(String name, int m, int count) {
        ...
        setTitle("Quiz Application - Question 8");
        ...
        JLabel headerLabel = new JLabel("Question 8");
        ...
        // Question label
        JLabel lblNewLabel = new JLabel("What is the output of System.out.println(\"5\" + 2 + 3)?");
        ...
        JRadioButton opt2 = new JRadioButton("523");
        ...
        JRadioButton opt3 = new JRadioButton("53");
        ...
        JRadioButton opt4 = new JRadioButton("5 + 2 + 3");
